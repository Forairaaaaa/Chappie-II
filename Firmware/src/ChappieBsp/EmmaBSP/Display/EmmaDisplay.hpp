...
/* If not, setup your own config here */
/* https://github.com/lovyan03/LovyanGFX/blob/master/src/lgfx_user/LGFX_ESP32_sample.hpp */
#ifndef LGFX_AUTODETECT

/// 独自の設定を行うクラスを、LGFX_Deviceから派生して作成します。
class LGFX_EmmaDisplay : public lgfx::LGFX_Device
{
/*
